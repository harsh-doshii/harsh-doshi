    ...
    <>
      <nav className='flex items-center flex-wrap bg-indigo-400 p-3 '>
          <a className='inline-flex items-center p-2 mr-4 '>
            ...
            <a  href = "mailto: doshiharsh26@gmail.com">
